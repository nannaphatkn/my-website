...
export const api = {
  ...
  selectSeat: (payload) => request("/api/bookings/select-seat", { method: "POST", body: JSON.stringify(payload) }),
  releaseSeat: (payload) => request("/api/bookings/release-seat", { method: "POST", body: JSON.stringify(payload) }),
