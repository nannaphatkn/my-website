  ...
  return (
    <div className={`flex items-center gap-2 font-display font-bold ${s}`}>
      ...
      <span className="text-stone-800 tracking-tight">
        Nod<span className="text-amber-600">Nod</span>
      </span>
    </div>
  );
}
...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <AuthCard poster={<PosterPanel title="Welcome back, music lover." subtitle="Access your NodNod tickets, upcoming shows, and favourite artists. Your stage is waiting." />}>
